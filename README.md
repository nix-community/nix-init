...
[![ci](https://img.shields.io/github/checks-status/nix-community/nix-init/main?style=flat-square)](https://nixbot.nix-community.org/repos/github/nix-community/nix-init)
